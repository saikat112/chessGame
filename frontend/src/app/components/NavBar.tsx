...
const NavBar: React.FC = () => {
  ...
  return (
    <Sidebar>
      {/* <SidebarItem icon={<PlayArrow />} text="Play" path="/play/play_online" /> */}
      <SidebarItem icon={<Public />} text="Play Online" path="/play/play_online" />
      <SidebarItem icon={<People />} text="Play with Friend" path="/play/play_with_friend" />
      <SidebarItem icon={<Computer />} text="Play with Computer" path="/play/play_with_computer" />
